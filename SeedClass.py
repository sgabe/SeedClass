...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('SeedClass.log', mode='a'),
...
parser = ArgumentParser(
    ...
    description='Binary classifier that extracts features from seed files and predicts their vulnerability potential.',
    prog='SeedClass'
)
